"""
Ejemplo rápido y simple para probar el sistema de votación
Ejecuta: python examples/quick_test.py
"""
...
def main():
    ...
    consultation_data = {
        "title": "Consulta de Ejemplo Rápido",
        "description": "Esta es una consulta de ejemplo creada para probar rápidamente el sistema de votación. Es una demostración funcional del endpoint de creación de consultas populares.",
    ...
    if consultation_id:
        ...
        # Esto probablemente dará error porque no conocemos los option_ids
        vote_data = {
    ...
    print("✅ Los endpoints principales del sistema de votación están funcionando")
    print("📚 Para más ejemplos, revisa:")
    print("   - examples/voting_example.py (ejemplo completo)")
    print("   - examples/curl_examples.md (ejemplos con curl)")
    print("   - VOTING_API_GUIDE.md (documentación completa)")
