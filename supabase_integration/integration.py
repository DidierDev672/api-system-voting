...
from system_voting.src.party_members.domain.ports.party_member_repository import (
    PartyMemberRepository,
)
from system_voting.src.party_members.domain.entities.party_member import PartyMember
from supabase_integration import services as supabase_services
...
class SupabasePartyMemberRepository(PartyMemberRepository):
    ...
    def save(self, party_member: PartyMember) -> PartyMember:
        ...
        try:
            ...
            result = supabase_services.party_members_service.create_member(member_data)
    ...
    def get_all(self) -> List[dict]:
        ...
        try:
            return supabase_services.party_members_service.get_all_records(
                "party_members"
            )
        except Exception as e:
    ...
    def get_by_id(self, member_id: str) -> Optional[dict]:
        ...
        try:
            return supabase_services.party_members_service.get_record_by_id(
                "party_members", member_id
            )
        except Exception as e:
    ...
    def get_by_document(self, document_number: str) -> Optional[dict]:
        ...
        try:
            return supabase_services.party_members_service.get_member_by_document(
                document_number
            )
        except Exception as e:
            logger.error(
                f"Error obteniendo miembro por documento {document_number}: {str(e)}"
            )
            raise
    ...
    def get_by_party(self, political_party_id: str) -> List[dict]:
        ...
        try:
            return supabase_services.party_members_service.get_members_by_party(
                political_party_id
            )
        except Exception as e:
            logger.error(
                f"Error obteniendo miembros del partido {political_party_id}: {str(e)}"
            )
            raise
    ...
    def update(self, member_id: str, data: dict) -> Optional[dict]:
        ...
        try:
            return supabase_services.party_members_service.update_record(
                "party_members", member_id, data
            )
        except Exception as e:
    ...
    def delete(self, member_id: str) -> bool:
        """Eliminar un miembro"""
        try:
            return supabase_services.party_members_service.delete_record(
                "party_members", member_id
            )
        except Exception as e:
...
from system_voting.src.political_parties.domain.ports.party_repository import (
...
class SupabasePoliticalPartyRepository(PoliticalPartyRepository):
    ...
    def save(self, party: PoliticalParty) -> PoliticalParty:
        ...
        try:
            ...
            result = supabase_services.political_parties_service.create_party(
                party_data
            )
    ...
    def get_all(self) -> List[dict]:
        ...
        try:
            return supabase_services.political_parties_service.get_all_active_parties()
        except Exception as e:
    ...
    def get_by_id(self, party_id: str) -> Optional[dict]:
        ...
        try:
            return supabase_services.political_parties_service.get_record_by_id(
    ...
    def get_by_name(self, name: str) -> Optional[dict]:
        ...
        try:
            return supabase_services.political_parties_service.get_party_by_name(name)
        except Exception as e:
    ...
    def update(self, party_id: str, data: dict) -> Optional[dict]:
        ...
        try:
            return supabase_services.political_parties_service.update_record(
                "political_parties", party_id, data
            )
        except Exception as e:
    ...
    def delete(self, party_id: str) -> bool:
        ...
        try:
            return supabase_services.political_parties_service.update_record(
                "political_parties", party_id, {"is_active": False}
            )
        except Exception as e:
    ...
    def get_statistics(self) -> List[dict]:
        ...
        try:
            return supabase_services.political_parties_service.get_party_statistics()
        except Exception as e:
...
def get_party_member_repository(use_supabase: bool = True):
    ...
    if use_supabase:
        ...
        from system_voting.src.party_members.infrastructure.repositories import (
...
def get_political_party_repository(use_supabase: bool = True):
    ...
    if use_supabase:
        ...
        from system_voting.src.political_parties.infrastructure.repositories import (
